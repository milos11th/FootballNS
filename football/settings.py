...
SECRET_KEY = 'django-insecure-wtn5z%^utrec%562m3x48)@2^d=($yjzuk#1p!7=@1^k43+hme'
...
EMAIL_HOST = 'smtp.gmail.com'  # Ili tvoj email provider
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'tomibre397@gmail.com'  
EMAIL_HOST_PASSWORD = 'gfvr hvec grhr ufga'  
